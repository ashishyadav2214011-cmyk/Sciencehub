const CACHE="sciencehub-v94-cache";
const ASSETS=[
 "./","./index.html","./style.css","./app.js","./sciencehub-enhancements.js",
 "./data/syllabus-fallback.js","./manifest.json",
...
self.addEventListener("fetch",e=>{
 ...
 e.respondWith(caches.match(e.request).then(c=>c||fetch(e.request).then(r=>{
   const cp=r.clone(); caches.open(CACHE).then(x=>x.put(e.request,cp)).catch(()=>{}); return r;
