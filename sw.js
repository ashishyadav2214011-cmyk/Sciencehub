const CACHE="sciencehub-v71-step9-final";
const ASSETS=["./","./index.html","./style.css","./app-step9.js","./manifest.json","./icon.svg","./sciencehub-icon.png","./sciencehub-icon-192.png"];
