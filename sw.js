const CACHE="sciencehub-v79-final";
const ASSETS=["./","./index.html","./style.css","./app-step9.js?v=79","./app.js","./manifest.json","./icon.svg","./sciencehub-icon.png","./sciencehub-icon-192.png","./home-hero.png","./sukoon-brain-figure.png"];
