const CACHE="sciencehub-v81-home-upmsp";
const ASSETS=["./","./index.html","./style.css","./app-step9.js?v=81","./app.js","./manifest.json","./icon.svg","./sciencehub-icon.png","./sciencehub-icon-192.png","./home-hero.png","./sukoon-brain-figure.png","./data/upmsp_syllabus_2026_27.json","./data/pyq_registry_2020_2026.json"];
